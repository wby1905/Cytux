...
extern "C" DLL_PUBLIC jlong Java_net_surina_soundtouch_SoundTouch_newInstance(JNIEnv *env,
                                                                              jclass thiz) {
...
extern "C" DLL_PUBLIC jfloat
Java_net_surina_soundtouch_SoundTouch_getMyBPM(JNIEnv *env, jobject thiz, jstring inFileName) {
    const char *inFilechar = env->GetStringUTFChars(inFileName, nullptr);
